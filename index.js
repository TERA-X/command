        ...
        mod.hook(mod.majorPatchVersion >= 90 ? 'S_REPLY_CLIENT_CHAT_OPTION_SETTING' : 'S_LOAD_CLIENT_USER_SETTING', 'event', () => {
            ...
            process.nextTick(() => {
                ...
                if (this.mod.settings.login_message)
                    this.message(null, `Publisher: ${this.mod.publisher.toUpperCase()} - Client: ${this.mod.majorPatchVersion}.${this.mod.minorPatchVersion} - Server: 104.1 - Protocol: ${this.mod.dispatch.protocolVersion}`);
